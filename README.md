...
```sh
git clone https://github.com/FAIRmat-NFDI/nomad-w90.git
cd nomad-w90
...
```sh
pip install dist/nomad-w90-0.1.0
```
...
| Name | E-mail     |
|------|------------|
| Vikrant Chaudhary | [16.vikrant@gmail.com](mailto:16.vikrant@gmail.com)
